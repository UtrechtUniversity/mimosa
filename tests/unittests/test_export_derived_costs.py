...
from mimosa.export.save import add_derived_global_cost_rows
...
def test_add_derived_global_cost_rows(simulation):
    model = _cost_model()
    ...
    rows = []
    add_derived_global_cost_rows(rows, output_model, all_variables)
