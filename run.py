...
AWSI_sample = random.lognormal(mean=1.84, sigma=0.20, size=1000)
...
AWSI_tipping_temp = random.choice(AWSI_sample)
...
params["tippingpoints"]["AWSI"]["threshold"] = AWSI_tipping_temp
...
model1.solve()
model1.save("run_with_threshold_quantiles_removed")
